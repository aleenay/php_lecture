...
$artist_query = "SELECT * FROM `tbl_artist`";
                        ...
                        <div class="QA_section">
                            ...
                            <div class="QA_table ">
                                ...
                                <table class="table lms_table_active">
                                    <thead>
                                        <tr>
                                            <th class="fw-bold">Artist Picture</th>
                                            <th class="fw-bold">Artist Name</th>
                                            <th class="fw-bold">Artist Category</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php while($row = mysqli_fetch_array($artist_query_run)){ ?>
                                        <tr>
                                            <td><img src=".<?php echo $row['artistpics']?>" width="100px" height="100"  alt=""></td>
