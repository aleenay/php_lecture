                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="quick_activity_wrap">
                                          <a class="single_quick_activity" href="addmusic.php">
                                                <h4>Add Music And Video</h4>
                                            </a>
                                            <a class="single_quick_activity" href="addalbum.php">

                                                <h4>Add Album</h4>
                                            </a>
                                            <a class="single_quick_activity" href="AddArtist.php">
                                                <h4>Add Artist</h4>
                                            </a>
                                        </div>
                                    </div>
