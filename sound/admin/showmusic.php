                            ...
                            <div class="QA_table ">
                                ...
                                <table class="table lms_table_active">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><img src="<?php echo $row['music_banner']?>" width="100px" height="100"  alt=""></td>
                                            <td><?php echo $row['music_title']  ?></td>
                                            <td><?php echo $row['artist_name']  ?></td>
                                            <td><?php echo $row['artist_category']  ?></td>
                                            <td><?php echo $row['date']   ?></td>
                                            <td><audio src="<?php echo $row['music_file']  ?>"></audio></td>
                                            <td><a href="deletemusic.php?id=<?php echo $row['id']?>" onclick="confirm('are you sure you want delete this music')" class="btn btn-danger text-white">Delete</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
