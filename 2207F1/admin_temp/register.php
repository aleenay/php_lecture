...
if(isset($_POST['btn_submit'])){
   ...
   $image = 'img/' . $img_name;
    ...
    $insert_query = "INSERT INTO `tbl_reg_user`( `u_name`, `u_email`, `u_img`, `u_pass`) VALUES ('$u_name','$u_email','$image','$u_pass')";
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="file" name="user_img" class="form-control " id="exampleInputEmail">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                ...
                                <input type="submit" name="btn_submit" value=" Register Account" class="btn btn-primary btn-user btn-block">
