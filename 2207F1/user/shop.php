...
?>
                        ...
                        <form action="insertcart.php" method="POST">
                            <div class="single-product">
                                ...
                                <img class="img-fluid" src="../admin_temp/<?php echo $data['p_img'];  ?>" alt="" > 
                                <div class="product-details">
                                    <h6><?php echo $data['p_name'];  ?></h6>
                                    <div class="price">
                                    ...
                                    <input type="hidden" value="<?php echo $data['p_name'];  ?>" name="p_name">
                                    <input type="hidden" value="<?php echo $data['p_price'];  ?>" name="p_price">
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"7b73d0da9e4a9fe3","version":"2023.3.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}'
